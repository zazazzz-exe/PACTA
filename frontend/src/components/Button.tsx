...
const styles: Record<Variant, string> = {
  primary: 'bg-accent text-white hover:bg-accent-deep btn-shimmer',
  secondary: 'bg-paper text-ink border border-hairline-strong hover:bg-accent-tint hover:border-accent/30',
